...
Zusätzlich soll das Mini-Backend soviel Fehlerhandhabung betrieben wie möglich. Die SPA soll Fehler nur bekommen wenn ein Dienst nicht verfügbar ist oder ein schwerwiegender Fehler passiert ist.
